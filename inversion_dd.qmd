...
::: {.card title="Variación Anual de la Inversión"}
```{r}
...
::: {.card title="Variación Mensual de la Inversión"}
```{r}
...
::: {.card title="Desempeño Histórico del Indicador de Formación de Capital Bruto"}
```{r}
...
ggplot() +
  ...
  labs(
    title = "Desemepeño Histórico de las Series de Formación de Capital Bruto",
    subtitle = 
    paste("Inversión productiva hasta ", text_cap),
    y = "Índice",
    x = "Año_Mes",
