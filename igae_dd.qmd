...
# importa datos
suppressMessages(source("source/data_igae_b2018.R",
                        echo = FALSE))
```
...
bslib::value_box(
  paste("Crecimiento Acumulado del Sexenio Actual hasta",
        format(ultim_fecha, "%b %Y")),
  theme = "primary",
  value = scales::percent((ultimo_actual_sexe - inicio_actual_sexe) / inicio_actual_sexe,
                          accuracy = 0.01)
)
```
:::
